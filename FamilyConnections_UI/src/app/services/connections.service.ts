...
export class ConnectionsService {
  ...
  constructor(private personsRepo: PersonsRepositoryService) { }
  ...
  private checkAllConnections(persons: IPerson[]): IFlatConnection[] {
    let newCons: IFlatConnection[] = [];

    let possibleComplex: IFlatConnection[] = [];
    let undecidedCons: IUndecidedConnection[] = [];
    ...
    persons.forEach(person => {
      try {
        ...
        let personCons: IConnection[] = person.FlatConnections.map(f => ({
